module github.com/opensecrecy/cryptctl

go 1.21.1

replace github.com/opensecrecy/encrypted-secrets => /Users/venkatesanv/work/oss/encrypted-secrets
...
require (
	...
	github.com/opensecrecy/encrypted-secrets v0.1.1
